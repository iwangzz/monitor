...
export default class Datatable extends Component {
    ...
    loadData(url) {
        $.getJSON('/campaigns/blacklist?offer_id=12256', function(res){
            if (res.status == 200) {
                this.setState( Object.assign({},this.state,{ entries: res.result }) )
    ...
    componentDidMount() {
         window.detailTable = $('.aff-table').dataTable({
